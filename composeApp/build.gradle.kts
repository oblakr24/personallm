...
val KEY_NAME = "OPENAI_API_KEY"
val openAiKey: String = localProps.getProperty(KEY_NAME, "")

tasks.register("generateSecretConstants") {
    ...
    doLast {
        ...
        commonMainDir.resolve("SecretConfig.kt").writeText(fileContent)
    }
}
...
kotlin.targets.all {
    compilations.all {
        compileTaskProvider.dependsOn("generateSecretConstants")
    }
}